#!/bin/sh 
DEMO="Cloud JBoss BPM Travel Agency Acquisition Demo"
...
echo
oc new-project rhcs-travel-agency-acquistion 
						
echo
echo "Setting up a new build..."
echo
oc new-build "jbossdemocentral/developer" --name=rhcs-travel-agency-acquisition --binary=true
...
echo
oc start-build rhcs-travel-agency-acquisition --from-dir=. --follow=true
...
echo
oc new-app rhcs-travel-agency-acquisition
...
echo
oc expose service rhcs-travel-agency-acquisition --hostname=rhcs-travel-agency-acquisition.10.1.2.2.xip.io
...
echo "=                                                                                         ="
echo "=    http://rhcs-travel-agency-acquisition.10.1.2.2.xip.io/business-central               ="
echo "=                                                                                         ="
...
echo "=                                                                                         ="
echo "=    http://rhcs-travel-agency-acquisition.10.1.2.2.xip.io/external-client-ui-form-1.0    ="
echo "=                                                                                ="101634
